                ...
                <div class="accordion .accordion-flush texto" id="accordionFlushExample">
                    <div class="accordion-item">
                        ...
                        <div id="flush-collapseOne" class="accordion-collapse collapse"
                            ...
                            <div class="accordion-body">Por supuesto, todos nuestros productos son nuevos y sellados.
                            </div>
                        </div>
                    </div>
                    <div class="accordion-item">
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="flush-collapseThree" class="accordion-collapse collapse"
                            ...
                            <div class="accordion-body">Si, tus pagos los puedes realizar con tarjeta sea VISA o
                                MasterCard.</div>
                        </div>
                    </div>
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="flush-collapseSix" class="accordion-collapse collapse"
                            ...
                            <div class="accordion-body">Por supuesto, siempre y cuando aún tengas tu comprobante de
                                pago.</div>
                        </div>
                    </div>
                </div>
